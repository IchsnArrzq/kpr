        ...
        <div class="landing-home" id="dashboards">
            <div class="container-fluid">
                <div class="sticky-header">
                    <header>
                        <nav class="navbar navbar-b navbar-trans navbar-expand-xl fixed-top nav-padding" id="sidebar-menu" style="font-family: Century Gothic;">
                            <a class="navbar-brand p-0" href="{{ route('index') }}"><img src="{{ asset('assets/images/logo-tni.png') }}" alt=""></a>
                ...
                <div class="row" id="#dashboards">
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeIn background" style="width:100%;margin-left:20px;">
                            <img style="width:100%;margin-left:20px;margin-top:200px;" src="{{asset('assets/images/Rumahbaru.png')}}" alt="rumah">
                        </div>
                    </div>
                </div>
            </div>
